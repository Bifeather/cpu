...
`define AluOpBus            7:0             //译码阶段的输出alupo_o的数据宽度
...
`define ChipEnable          1'b1            //使能芯片
`define ChipDisable         1'b0            //禁止芯片
...
`define EXE_SPECIAL_INST    6'b000000       //特殊指令码
...
`define InstMenNum          131071          //ROM的实际大小128KB
...
`define RegNumLos2          5               //通用寄存器使用的地址位数
